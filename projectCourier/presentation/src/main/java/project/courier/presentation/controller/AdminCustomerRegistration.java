...
public class AdminCustomerRegistration implements Initializable {
    @FXML
    ...
    public void registerCustomer(){
        ...
        customerModel.setCompany(CompanyCombo.getValue());
    ...
    public void initialize(URL location, ResourceBundle resources)
    {
        ...
        companyProvider.getNames().forEach(e -> CompanyCombo.getItems().add(e));
    }
}
